...
class Guild(sql.Model):
    ...
    ----------
    id : int - pk
        Autogenerated database id
    guild_id : int - required, unique
        Snowflake id of the guild.
    name : str - required
        Name of the guild
    last_activity : str
        Last activity performed in the guild.
    last_active_channel : int - default = 0
        Snowflake id of the last channel to receive activity.
